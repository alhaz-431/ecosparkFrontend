  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        {/* Filters */}
        <div className="bg-white p-4 rounded-2xl shadow mb-8 flex flex-wrap gap-4 items-center">
          <select
            value={category}
            onChange={(e) => { setCategory(e.target.value); setPage(1); }}
            className="border p-2 rounded-lg text-sm focus:outline-none focus:border-green-500"
          >
